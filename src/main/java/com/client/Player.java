...
public final class Player extends Entity {
	...
	public Model getRotatedModel() {
		...
		model.fits_on_single_square = true;
		/*if (super.field1189 != 0 && Client.loopCycle >= super.field1133 && Client.cycle < super.field1185) { // L: 278
			model.overrideHue = super.field1146; // L: 279
			model.overrideSaturation = super.field1187; // L: 280
			model.overrideLuminance = super.field1188; // L: 281
			model.overrideAmount = super.field1189; // L: 282
		} else {
			model.overrideAmount = 0; // L: 285
		}*/
		return model;
	}
	...
	public void updatePlayer(Buffer stream) {
		...
		for (int j = 0; j < 12; j++) {
			...
			if (j == 0 && equipment[0] == 65535) {
				desc = NpcDefinition.forID(stream.readUnsignedShort());
				break;
			}
