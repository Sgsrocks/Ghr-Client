...
public class ItemDefinition_Sub5 {

    public ItemDefinition_Sub5()
    {
    }
    public static ItemDefinition itemDef(int i, ItemDefinition class8) {
        ...
        if(i == 29572) //ID
        {
            class8.itemActions = new String[] {null, "Wear", null, null, "Drop"};
            class8.groundActions = new String[] {null, null, "Take", null, null};
            class8.name = "Inverted Infernal max cape"; //Name
            class8.description = "Its an Inverted Infernal max cape"; //Description
            class8.originalTextureColors = new short[1];
            class8.modifiedTextureColors = new short[1];
            class8.originalTextureColors[0] = 59;
            class8.modifiedTextureColors[0] = 102;
            class8.modelId = 33145;
            ...
            class8.spriteTranslateX = 0;
            class8.spriteTranslateY = -5;
            class8.primaryMaleModel = 33102;
            class8.primaryFemaleModel = 33114;
            class8.secondaryMaleModel = -1;
            class8.secondaryFemaleModel = -1;
            class8.primaryMaleHeadPiece = -1;
            class8.primaryFemaleHeadPiece = -1;
        ...
        if(i == 29573) //ID
        {
            class8.itemActions = new String[]{null, "Wear", null, null, "Drop"};
            class8.groundActions = new String[] {null, null, "Take", null, null};
            class8.name = "Range Infernal max cape"; //Name
            class8.description = "Its an Range Infernal max cape"; //Description
            class8.originalTextureColors = new short[1];
            class8.modifiedTextureColors = new short[1];
            class8.originalTextureColors[0] = 59;
            class8.modifiedTextureColors[0] = 100;
        ...
        if(i == 29574) //ID
        {
            class8.itemActions = new String[] {null, "Wear", null, null, "Drop"};
            class8.groundActions = new String[] {null, null, "Take", null, null};
            class8.name = "Magic Infernal max cape"; //Name
            class8.description = "Its an Magic Infernal max cape"; //Description
            class8.originalTextureColors = new short[1];
            class8.modifiedTextureColors = new short[1];
            class8.originalTextureColors[0] = 59;
            class8.modifiedTextureColors[0] = 98;
