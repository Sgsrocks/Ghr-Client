...
public class FloorDefinition {
        ...
        public static void init(FileArchive archive) {
            ...
            int underlayAmount = buffer.readUnsignedShort();
            ...
            int overlayAmount = buffer.readUnsignedShort();
        ...
        private void generateHsl(boolean isUnderlay) {
            ...
            int color = isUnderlay && Configuration.snow ? 0xFFFFFF : rgb;
            rgbToHsl(color);
        }

        private void readValuesUnderlay(Stream buffer) {
            for (; ; ) {
        ...
        private void readValuesOverlay(Stream buffer) {
            for (; ; ) {
                int opcode = buffer.readUnsignedByte();
                if (opcode == 0) {
                    break;
