...
//jump
	private void renderObject(int y, WorldController worldController, CollisionMap class11, int type, int z, int x,
		...
		if (type == 10 || type == 11) {
			...
			if (obj1 != null) {
				...
				if (worldController.method284(key, byte0, k2, l4, ((Renderable) (obj1)), j4, z, i5, y, x, id)
		...
		if (type >= 12) {
			...
			worldController.method284(key, byte0, k2, 1, ((Renderable) (obj2)), 1, z, 0, y, x, id);
		...
		if (type == 0) {
			...
			worldController.method282(anIntArray152[j1], ((Renderable) (obj3)), key, y, byte0, x, null, k2, 0, z, id);
			if (j1 == 0) {
		...
		if (type == 1) {
			...
			worldController.method282(anIntArray140[j1], ((Renderable) (obj4)), key, y, byte0, x, null, k2, 0, z, id);
			if (definition.aBoolean779)
				if (j1 == 0)
					shading[z][x][y + 1] = 50;
				else if (j1 == 1)
		...
		if (type == 3) {
			...
			worldController.method282(anIntArray140[j1], ((Renderable) (obj5)), key, y, byte0, x, null, k2, 0, z, id);
			if (definition.aBoolean779)
				if (j1 == 0)
					shading[z][x][y + 1] = 50;
				else if (j1 == 1)
		...
		if (type == 9) {
			...
			worldController.method284(key, byte0, k2, 1, ((Renderable) (obj6)), 1, z, 0, y, x, id);
			if (definition.aBoolean767 && class11 != null)
				class11.method212(definition.aBoolean757, definition.anInt744, definition.anInt761, x, y, j1);
			return;
		}
		...
		if (type == 6) {
			...
			worldController.method283(key, y, j1, z, 0, k2, ((Renderable) (obj8)), x, byte0, 0, 256, id);
			return;
		}
		if (type == 7) {
			Object obj9;
			...
			worldController.method283(key, y, j1, z, 0, k2, ((Renderable) (obj9)), x, byte0, 0, 512, id);
			return;
		}
		if (type == 8) {
			Object obj10;
			...
			worldController.method283(key, y, j1, z, 0, k2, ((Renderable) (obj10)), x, byte0, 0, 768, id);
		}
	}
	...
	public static void method188(WorldController worldController, int i, int j, int k, int l, CollisionMap class11,
		...
		if (k == 10 || k == 11) {
			...
			if (obj1 != null) {
				...
				worldController.method284(i3, byte1, l2, i5, ((Renderable) (obj1)), k4, k1, j5, j, i1, j1);
			}
		...
		if (k >= 12) {
			...
			worldController.method284(i3, byte1, l2, 1, ((Renderable) (obj2)), 1, k1, 0, j, i1, j1);
			if (class46.aBoolean767)
				class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, i1, j, i);
			return;
		}
		if (k == 0) {
			...
			worldController.method282(anIntArray152[i], ((Renderable) (obj3)), i3, j, byte1, i1, null, l2, 0, k1, j1);
			if (class46.aBoolean767)
		...
		if (k == 1) {
			...
			worldController.method282(anIntArray140[i], ((Renderable) (obj4)), i3, j, byte1, i1, null, l2, 0, k1, j1);
			if (class46.aBoolean767)
				class11.method211(j, i, i1, k, class46.aBoolean757);
			return;
		}
		...
		if (k == 3) {
			...
			worldController.method282(anIntArray140[i], ((Renderable) (obj5)), i3, j, byte1, i1, null, l2, 0, k1, j1);
			if (class46.aBoolean767)
				class11.method211(j, i, i1, k, class46.aBoolean757);
			return;
		}
		if (k == 9) {
			...
			worldController.method284(i3, byte1, l2, 1, ((Renderable) (obj6)), 1, k1, 0, j, i1, j1);
			if (class46.aBoolean767)
				class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, i1, j, i);
			return;
		} // try
		...
		if (k == 4) {
			...
			worldController.method283(i3, j, i * 512, k1, 0, l2, ((Renderable) (obj7)), i1, byte1, 0, anIntArray152[i], j1);
			return;
		}
		if (k == 5) {
			int j4 = 16;
		...
		if (k == 6) {
			...
			worldController.method283(i3, j, i, k1, 0, l2, ((Renderable) (obj8)), i1, byte1, 0, 256, j1);
			return;
		}
		if (k == 7) {
			Object obj9;
			...
			worldController.method283(i3, j, i, k1, 0, l2, ((Renderable) (obj9)), i1, byte1, 0, 512, j1);
			return;
		}
		if (k == 8) {
			Object obj10;
			...
			worldController.method283(i3, j, i, k1, 0, l2, ((Renderable) (obj10)), i1, byte1, 0, 768, j1);
		}
	}
	...
	public final void method190(int i, CollisionMap aclass11[], int j, WorldController worldController, byte abyte0[]) {
		label0: {
			...
			int objId = -1;
			do {
				int objIdOffset = stream.getUIncrementalSmart();
				if (objIdOffset == 0)
					break label0;
				objId += objIdOffset;
				int objPosInfo = 0;
